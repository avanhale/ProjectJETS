...
namespace VRTK.CustomScripts
{
    public class VRTKCustom_HapticFeedback : MonoBehaviour
    {
        ...
        protected IEnumerator HapticPulseRoutine(float pulseDuration, float intervalDuration, float totalDuration, float intensity, bool isContinuous, bool isRHand)
        {
